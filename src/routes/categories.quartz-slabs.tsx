  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Engineered Quartz Slabs from Egypt | Route Export" },
      {
        ...
        content: "The original Egyptian quartz surface: 15/20/30mm slabs in seamless jumbo sizes.",
      },
...
const collections = [
  {
    name: "Terra Series",
    code: "4535 Terre Grey",
    img: slab1,
    tone: "Warm grey with soft veining",
  },
  {
    name: "Signature Whites",
    code: "White Marble Look",
    img: slab2,
    tone: "Crisp whites with dramatic veins",
  },
  {
    name: "Natural Tones",
    code: "Beige & Sand",
    img: slab3,
    tone: "Earthy neutrals inspired by nature",
  },
];
...
function QuartzSlabsPage() {
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="container-x">
          ...
          <h1 className="mt-6 font-display text-5xl md:text-7xl leading-[1.05] max-w-3xl">
            {isAr
              ? "الكوارتز المصنّع — السطح المصري الأصلي."
              : "The original Egyptian quartz surface."}
          </h1>
          ...
          <div className="flex items-end justify-between mb-10 gap-6">
            <div>
              ...
              <h2 className="mt-2 font-display text-4xl">
                {isAr ? "المجموعات الرئيسية" : "Signature collections"}
              </h2>
            </div>
          </div>
            ...
            {collections.map((c, i) => (
              ...
              >
                <div className="aspect-[4/5] overflow-hidden bg-muted">
                  <img
                    src={c.img}
                    alt={`${c.name} — ${c.tone} Egyptian engineered quartz slab`}
                    width={800}
                    height={1000}
                    loading="lazy"
                    decoding="async"
        ...
        <div className="container-x grid md:grid-cols-2 gap-12">
          <div className="rounded-2xl bg-ink text-cream p-10">
            ...
            <h3 className="font-display text-3xl text-cream">
              {isAr
                ? "أحجام تسمح بتصاميم كبيرة بلا فواصل."
                : "Sizes that allow seamless, large-format designs."}
            </h3>
      ...
      <section className="py-16">
        <div className="container-x">
          <div className="text-xs uppercase tracking-[0.22em] text-gold mb-3">
...
function Cell({ v, highlight }: { v: boolean; highlight?: boolean }) {
  return (
    <td className="px-6 py-4 text-center">
      {v ? (
        <span
          className={`inline-flex h-6 w-6 items-center justify-center rounded-full ${highlight ? "bg-gold text-ink" : "bg-primary/10 text-primary"}`}
        >
