  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Fertilizers & Crop Protection | Route Export" },
      {
        ...
        content:
          "ISO-certified Egyptian fertilizers, micronutrients and bio-stimulants prepared for export.",
      },
    ...
    items: [
      {
        name: "NPK 19-19-19",
        spec: "19 – 19 – 19",
        use: { en: "Balanced nutrition for all stages.", ar: "تغذية متوازنة لكل المراحل." },
      },
      {
        name: "NPK 20-20-20",
        spec: "20 – 20 – 20",
      ...
      },
      {
        name: "NPK 6-6-43",
        spec: "6 – 6 – 43",
        use: { en: "Fruit sizing and colouring.", ar: "تكبير الثمار وتحسين اللون." },
      },
      {
        name: "NPK 9-0-40",
        spec: "9 – 0 – 40",
        use: { en: "Potassium-led productive stage.", ar: "مرحلة إنتاج بقيادة البوتاسيوم." },
      },
      {
        name: "NPK 0-0-50",
        spec: "0 – 0 – 50",
        use: { en: "Pure potassium top-up.", ar: "دعم بوتاسي خالص." },
      },
      {
        name: "Techno Valley 20-20-20",
        spec: "20 – 20 – 20",
        use: { en: "Multi-purpose bucket pack.", ar: "عبوة متعددة الأغراض." },
      },
      {
        name: "Techno Valley 10-40-10",
        spec: "10 – 40 – 10",
        use: { en: "Phosphorus push after planting.", ar: "دفعة فوسفور بعد الزراعة." },
      },
      {
        name: "Techno Valley 5-5-40",
        spec: "5 – 5 – 40",
        use: { en: "Late-season potassium feed.", ar: "تغذية بوتاسية في نهاية الموسم." },
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Techno Valley 12-12-36",
        spec: "12 – 12 – 36",
        use: { en: "Potassium-rich productive blend.", ar: "خليط إنتاجي غني بالبوتاسيوم." },
      },
      {
        name: "Techno Valley 34-10-10",
        spec: "34 – 10 – 10",
        use: { en: "High nitrogen for vegetative growth.", ar: "نيتروجين عالٍ للنمو الخضري." },
      },
      {
        name: "Techno Valley 18-18-5",
        spec: "18 – 18 – 5",
        use: { en: "Starter blend for early stages.", ar: "خليط بادئ للمراحل المبكرة." },
      },
      {
        name: "Techno Valley 12-12-17",
        spec: "12 – 12 – 17",
        use: { en: "General field maintenance feed.", ar: "تغذية عامة لصيانة المحصول." },
      },
      {
        name: "Potassium Sulphate",
        spec: "0 – 0 – 50",
        use: { en: "Chloride-free potassium source.", ar: "مصدر بوتاسيوم خالٍ من الكلور." },
      },
      {
        name: "MAP",
        spec: "12 – 61 – 0",
        use: { en: "Mono-ammonium phosphate for rooting.", ar: "فوسفات أحادي الأمونيوم للتجذير." },
      },
      {
        name: "Andol 5%",
        spec: "Soil amendment",
        use: { en: "Soil treatment additive.", ar: "مُحسِّن ومعالج للتربة." },
      },
      {
        name: "Mix Fert Plus",
        spec: "Compound mix",
        use: { en: "Complete multi-nutrient blend.", ar: "خليط متكامل متعدد العناصر." },
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Techno Valley Cal",
        spec: "Calcium",
        use: {
          en: "Firmer fruit, less cracking and blossom-end rot.",
          ar: "صلابة الثمار وتقليل التشقق وعفن الطرف الزهري.",
        },
      },
      {
        name: "Techno Valley Amino",
        spec: "Amino acids",
        use: {
          en: "Stress recovery and faster nutrient uptake.",
          ar: "تجاوز الإجهاد وتسريع امتصاص العناصر.",
        },
      },
      {
        name: "Techno Valley Phos",
        spec: "Phosphorus",
        use: { en: "Root and flower stimulation.", ar: "تنشيط الجذور والإزهار." },
      },
      {
        name: "Techno Valley Pota Setrite",
        spec: "Potassium citrate",
        use: { en: "Most absorbable potassium form.", ar: "أسرع صور البوتاسيوم امتصاصاً." },
      },
      {
        name: "Techno Valley Cayto",
        spec: "Cytokinin blend",
        use: { en: "Cell division and uniform fruit set.", ar: "انقسام الخلايا وانتظام العقد." },
      },
      {
        name: "Valley Sal",
        spec: "Salinity corrector",
        use: {
          en: "Helps crops tolerate saline soil and water.",
          ar: "يساعد المحصول على تحمّل ملوحة التربة والمياه.",
        },
      },
      {
        name: "Techno Valley Mix",
        spec: "Multi-element liquid",
        use: { en: "Corrects several deficiencies at once.", ar: "يعالج عدة نواقص في وقت واحد." },
      },
    ],
  },
  {
    ...
    items: [
      {
        name: "Techno Valley Humic",
        spec: "Humic acid",
        use: {
          en: "Soil structure and nutrient retention.",
          ar: "تحسين بناء التربة والاحتفاظ بالعناصر.",
        },
      },
      {
        name: "Techno Valley Fulvic",
        spec: "Fulvic acid",
        use: { en: "Carrier that boosts element uptake.", ar: "ناقل يرفع كفاءة امتصاص العناصر." },
      },
      {
        name: "Techno Valley Iron",
        spec: "Chelated Fe",
        use: {
          en: "Prevents and treats iron chlorosis.",
          ar: "الوقاية من اصفرار نقص الحديد وعلاجه.",
        },
      },
      {
        name: "Techno Valley Zinc",
        spec: "Chelated Zn",
        use: { en: "Growth hormone formation.", ar: "تكوين هرمونات النمو." },
      },
      {
        name: "Techno Valley Manganese",
        spec: "Chelated Mn",
        use: { en: "Enzyme activity and photosynthesis.", ar: "نشاط الإنزيمات والتمثيل الضوئي." },
      },
      {
        name: "Algae-X",
        spec: "Seaweed extract",
        use: {
          en: "Natural stimulant for vigour and stress tolerance.",
          ar: "محفز طبيعي للحيوية وتحمّل الإجهاد.",
        },
      },
      {
        name: "Flower-Up",
        spec: "Flowering booster",
        use: { en: "More flowers and better fruit set.", ar: "زيادة الإزهار وتحسين العقد." },
      },
      {
        name: "Mix Fert",
        spec: "Micro-element mix",
        use: { en: "Balanced micronutrient correction.", ar: "تصحيح متوازن للعناصر الصغرى." },
      },
    ],
  },
];
...
const strengths = [
  {
    ...
    en: {
      t: "Own manufacturing",
      d: "Fertilizers produced and packed on modern production lines in Sadat City, Menoufia.",
    },
    ar: {
      t: "تصنيع ذاتي",
      d: "أسمدة تُنتج وتُعبأ على خطوط إنتاج حديثة بمدينة السادات — المنوفية.",
    },
  },
  {
    icon: ShieldCheck,
    en: {
      t: "ISO 9001 & ISO 14001",
      d: "Certified quality and environmental management across production.",
    },
  ...
  },
  {
    ...
    en: {
      t: "Crop protection",
      d: "Pesticide range that controls pests with minimal environmental impact.",
    },
  ...
  },
  {
    ...
    en: {
      t: "Agronomy support",
      d: "Technical guidance on product selection and application programmes.",
    },
      ...
      <section className="py-16 border-t border-border">
        <div className="container-x text-center">
          <p className="text-sm text-muted-foreground mb-6">
            {isAr
              ? "بروفايل الشركة الكامل بالمنتجات والاعتمادات (PDF)"
              : "Full company profile with products and certifications (PDF)"}
          </p>
          <a
